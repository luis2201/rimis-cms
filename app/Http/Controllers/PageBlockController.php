...
class PageBlockController extends Controller
{
    ...
    private function validateBlock(Request $request): array
    {
        $validated = $request->validate([
            ...
            'title' => [Rule::requiredIf($request->input('type') === 'image_card'), 'nullable', 'string', 'max:255'],
            'subtitle' => ['nullable', 'string', 'max:500'],
            'content' => [Rule::requiredIf($request->input('type') === 'image_card'), 'nullable', 'string'],
            'image_id' => [Rule::requiredIf($request->input('type') === 'image_card'), 'nullable', 'integer', 'exists:media_files,id'],
        ...
        $data = array_filter([
            ...
            'content' => in_array($type, ['text', 'text_image', 'image_card', 'html'], true) ? $this->sanitizer->clean($content) : $content,
